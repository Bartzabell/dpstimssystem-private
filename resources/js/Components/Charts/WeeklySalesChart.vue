...
export default {
    ...
    methods: {
        ...
        async fetchWeeklySalesData() {
            try {
                const response = await axios.get('/api/sales/weekly-sales-by-item', {
                    params: {
...
<template>
    <div>
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-semibold" :class="{ 'text-white': isDarkMode }">Weekly Sales by Item</h2>
            <button
                @click="refreshChart"
