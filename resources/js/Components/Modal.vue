...
<template>
    <dialog class="w-auto min-h-full m-0 overflow-y-auto bg-transparent backdrop:bg-transparent" ref="dialog">
      <div class="fixed inset-0 flex items-center justify-center px-4 py-6 overflow-y-auto sm:px-0" style="z-index: 40;" scroll-region>
        <!-- Backdrop -->
        <transition
        ...
        >
          <div 
            v-show="show" 
            class="w-auto mb-6 overflow-hidden transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-800 sm:mx-auto max-h-[90vh] flex flex-col" 
            :class="maxWidthClass"
          >
