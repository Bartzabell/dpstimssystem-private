...
<template>
    <div class="relative" ref="dropdownRef">
        <div class="relative w-full rounded-lg cursor-pointer select-none dark:bg-gray-500"
        ...
        <div v-if="isOpen"
            ...
            <div v-for="item in filteredItems" :key="item.id" @mousedown.prevent="selectItem(item)"
